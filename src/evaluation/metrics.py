...
class CostMatrix:
    ...
    def from_yaml(cls, path: str) -> "CostMatrix":
        ...
        return cls(
            false_negative_cost_usd=float(cfg["derived"]["false_negative_cost_usd"]),
            false_positive_cost_usd=float(cfg["derived"]["false_positive_cost_usd"]),
            investigator_hourly_rate_usd=float(
                cfg["economic_assumptions"]["investigator_hourly_rate_usd"]
            ),
            daily_alert_capacity_per_analyst=int(
